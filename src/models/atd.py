...
if __name__ == '__main__':
    ...
    summary(model, input_size=(2, 1, 15, 15))
...
def create_atd_single(params: dict, in_dim: int, upscale: int):
    ...
    model = ATD(
        ...
        category_size=p["category_size"],
        num_tokens=p["num_tokens"],
        reducted_dim=p["reducted_dim"],
        convffn_kernel_size=p["convffn_kernel_size"],
        img_range=p["img_range"],
